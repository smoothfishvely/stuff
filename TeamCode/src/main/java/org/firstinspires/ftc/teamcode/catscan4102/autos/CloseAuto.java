...
import org.firstinspires.ftc.teamcode.catscan4102.commands.PositionDoors;
    ...
    public void scheduleAuto(){
        CommandScheduler.getInstance().schedule(
                ...
                new SequentialCommandGroup(
                        ...
                        new WaitCommand(600),
                        new AutoShoot(bot), //shoot first 3
                        new ParallelCommandGroup(
                        ...
                        new WaitCommand(600),
                        new AutoShoot(bot), //3 balls scored (6 total)
                        new ParallelCommandGroup(
                        ...
                        new WaitCommand(550),
                        new AutoShoot(bot), //3 balls scored (9 total)
                        ...
                        new WaitCommand(600),
                        new AutoShoot(bot) //3 balls scored (12 total)
                )
        );
    }
